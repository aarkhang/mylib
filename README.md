...
[![Статус сборки](https://travis-ci.com/aarkhang/mylib.svg?branch=master)](https://travis-ci.com/aarkhang/mylib) [![Статус сборки под Виндой](https://ci.appveyor.com/api/projects/status/github/aarkhang/mylib?branch=master&svg=true)](https://ci.appveyor.com/project/aarkhang/mylib/branch/master) [![Статус покрытия](https://coveralls.io/repos/github/aarkhang/mylib/badge.svg?branch=master)](https://coveralls.io/github/aarkhang/mylib?branch=master) [![Попробовать онлайн на Wandbox.org](https://img.shields.io/badge/try-online-blue.svg)](https://wandbox.org/permlink/QElvxuMzHgL9fqci)
